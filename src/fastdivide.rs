// Copied from fastdivide library to avoid any dependencies as it's a single file.
// You can find the repository here: https://github.com/fulmicoton/fastdivide
// Here is the license and the code
