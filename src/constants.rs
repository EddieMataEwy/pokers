...
pub const PERF_HASH_ROW_SHIFT: usize = 12;

pub const CARD_COUNT_SHIFT: u8 = 32;
pub const SUITS_SHIFT: u8 = 48;
pub const FLUSH_CHECK_MASK64: u64 = 0x8888u64 << SUITS_SHIFT;
pub const FLUSH_CHECK_MASK32: u32 = 0x8888u32 << (SUITS_SHIFT - 32) as u32;
